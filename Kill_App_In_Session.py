...
#Address to call on
target = "https://horizon.evengooder.com/rest/helpdesk/v1/performance/remote-application"
...
target = "https://horizon.evengooder.com/rest/helpdesk/v1/performance/remote-application/action/end-remote-application"
